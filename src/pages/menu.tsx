    ...
    <div>
        ...
        <div className="w-[350px] md:w-[700px] lg:w-[1000px] xl:w-[1200px]">
          ...
          <div className="w-full grid lg:grid-cols-2 gap-7">
            {menu.favourites.items.map(item => <div className="mt-5" key={item.name[t]}>
              <h2 className="text-[25px] md:text-[32px] text-primary font-bold">{item.name[t]} {item.price && item.price+" kr"}</h2>
      ...
      <div className="flex justify-center my-[100px]">
        <div className="w-[350px] md:w-[700px] lg:w-[1000px] xl:w-[1200px]">
          ...
          <div className="flex items-center gap-5" id={menu.thali.name.en}><h1 className="text-[27px] md:text-[40px] font-bold text-primary">{menu.thali.name[t]}</h1><hr className="flex-1 border-[1px] border-primary" /></div>
          <div className="w-full grid lg:grid-cols-3">
      ...
      <div className="flex justify-center mt-[50px] mb-[100px]">
        <div className="w-[350px] md:w-[700px] lg:w-[1000px] xl:w-[1200px]">
          <div className="flex items-center gap-5" id={menu.vegan.name.en}><h1 className="text-[27px] md:text-[40px] font-bold text-primary">{menu.vegan.name[t]}</h1></div>
          <div className="w-full grid lg:grid-cols-3">
      ...
      <div className="flex justify-center my-[100px]">
        <div className="w-[350px] md:w-[700px] lg:w-[1000px] xl:w-[1200px]">
          ...
          <div className="flex items-center gap-5" id={menu.clay_oven.name.en}><h1 className="text-[27px] md:text-[40px] font-bold text-primary">{menu.clay_oven.name[t]}</h1><hr className="flex-1 border-[1px] border-primary" /></div>
      ...
      <div className="flex justify-center my-[100px]">
        <div className="w-[350px] md:w-[700px] lg:w-[1000px] xl:w-[1200px]">
          ...
          <div className="flex items-center gap-5" id={menu.mughlai_dishes.name.en}><h1 className="text-[27px] md:text-[40px] font-bold text-primary">{menu.mughlai_dishes.name[t]}</h1><hr className="flex-1 border-[1px] border-primary" /></div>
          <div className="w-full grid lg:grid-cols-1 gap-7">
      ...
      <div className="flex justify-center my-[100px]">
        <div className="w-[350px] md:w-[700px] lg:w-[1000px] xl:w-[1200px]">
          ...
          <div className="flex items-center gap-5" id={menu.bengali_ratter.name.en}><h1 className="text-[27px] md:text-[40px] font-bold text-primary">{menu.bengali_ratter.name[t]}</h1><hr className="flex-1 border-[1px] border-primary" /></div>
          <div className="w-full grid lg:grid-cols-1 gap-7">
      ...
      <div className="flex justify-center my-[100px]">
        <div className="w-[350px] md:w-[700px] lg:w-[1000px] xl:w-[1200px]">
          ...
          <div className="flex items-center gap-5" id={menu.fish_and_seafood.name.en}><h1 className="text-[27px] md:text-[40px] font-bold text-primary">{menu.fish_and_seafood.name[t]}</h1><hr className="flex-1 border-[1px] border-primary" /></div>
          <div className="w-full grid lg:grid-cols-3">
