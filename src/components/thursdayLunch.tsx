export default function ThursdayLunch({ lunch }: { lunch: string }) {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      <h1 className="text-[50px] font-semibold text-primary">TORSDAG</h1>
      <div className="w-full mt-10 grid gap-10">
        ...
        <div className="flex justify-between items-start">
          <div>
            <h3 className="text-3xl font-semibold text-primary">4. DALL MIX</h3>
            <p className="text-xl">
              (Exotiska blandade linser med indiska kryddor, Mellan)
            </p>
          </div>
          <hr className="flex-1 border mx-4 border-black mt-5" />
          <p className="text-3xl font-semibold">120kr</p>
        </div>
      </div>
